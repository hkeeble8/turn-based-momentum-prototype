...
func init_ui(settlement: SimulationEntity) -> void:
	var settlement_aspect = settlement.aspects[SimulationAspect.Type.SETTLEMENT]

	var settlement_relationships = settlement.aspects[SimulationAspect.Type.RELATIONSHIPS]
