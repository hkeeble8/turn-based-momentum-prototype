...
func _init_collision_shape() -> void:
	var collision_area = CollisionAreaFactory.create(1, Vector2(15, 3))
...
func serialize() -> Dictionary:
	var data = {}
	if animated_sprite != null:
		data["animated_sprite"] = animated_sprite.sprite_frames.resource_path
		data["offset"] = {
			"x": animated_sprite.offset.x,
